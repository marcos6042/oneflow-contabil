...
export function AprovarLancamentos() {
  const dados = [
    { descricao: 'Pix Aluguel', valor: 2800, contaDeb: 'Aluguel', contaCred: 'Banco' },
    { descricao: 'Combustível', valor: 300, contaDeb: 'Combustível', contaCred: 'Conta Garantida' }
  ];
  return (
    <div className="p-6">
      ...
      <table className="w-full border">
        <thead className="bg-gray-100">
          <tr><th>Descrição</th><th>Valor</th><th>Débito</th><th>Crédito</th><th>Aprovar</th></tr>
        </thead>
        <tbody>
          {dados.map((l, i) => (
